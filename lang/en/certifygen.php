...
$string['subplugintype_certifygenreport_plural'] = 'Unimoodle certifygen teacher use reports';
$string['subplugintype_certifygenrepository_plural'] = 'Unimoodle certifygen certificate storages.';
