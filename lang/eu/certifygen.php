...
$string['privacy:metadata:validationid'] = 'O ID da instancia de validación do certificado';
$string['privacy:metadata:url'] = 'Ligazón á localización do repositorio';
$string['privacy:metadata:data'] = 'Datos relacionados coa localización do repositorio';
