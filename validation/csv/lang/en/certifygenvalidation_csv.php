...
$string['firmacatalogserviceurl_help'] = 'This is the FirmaCatalogService url. <span class="bold">It is required in all the requests.</span>';
$string['firmaquerycatalogserviceurl'] = 'FirmaQueryCatalogService URL';
$string['firmaquerycatalogserviceurl_help'] = 'This is the FirmaQueryCatalogService url. <span class="bold">It is required in all the requests.</span>';
...
$string['getstatuserror'] = 'Error getting status';
$string['validationidnotfound'] = 'Validation ID not found';
$string['certifygenvalidationcsvnotfound'] = 'Certifygen validation csv not found';
