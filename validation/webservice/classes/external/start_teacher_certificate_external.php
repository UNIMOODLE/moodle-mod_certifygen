...
/**
 * Initialise teacher certificate issue teacher certificate (issue it if it is not already created)
 * @package    certifygenvalidation_webservice
 * @copyright  2024 Proyecto UNIMOODLE
 * @author     UNIMOODLE Group (Coordinator) <direccion.area.estrategia.digital@uva.es>
 * @author     3IPUNT <contacte@tresipunt.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class start_teacher_certificate_external extends external_api {
    /**
     * Describes the external function parameters.
     *
     * @return external_function_parameters
     */
    public static function start_teacher_certificate_parameters(): external_function_parameters {
     ...
     */
    public static function start_teacher_certificate(
        int $userid,
        string $userfield,
        string $name,
        string $courses,
        ...
        $params = self::validate_parameters(
            self::start_teacher_certificate_parameters(),
            [
                'userid' => $userid,
                'userfield' => $userfield,
                'name' => $name,
        ...
        try {
            ...
            if ($trequest) {
                ...
                $trequest = certifygen_validations::manage_validation(0, (object) $data);
            }
     ...
     */
    public static function start_teacher_certificate_returns(): external_single_structure {
