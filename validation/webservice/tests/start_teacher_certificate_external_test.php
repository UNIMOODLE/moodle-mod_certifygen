 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class start_teacher_certificate_external_test extends advanced_testcase {
    /**
     * Test set up.
     */
    ...
    public function test_1(): void {
        ...
        $this->assertEquals(certifygen_model::TYPE_TEACHER_ALL_COURSES_USED, $startresult['certificate']['reporttype']);
        $this->assertIsInt($startresult['certificate']['validationid']);
    }
    /**
     * Test 2: userfield
     *
    ...
    public function test_2(): void {
        ...
        $this->assertArrayHasKey('error', $startresult);
        $this->assertIsArray($startresult['error']);
        $this->assertArrayHasKey('code', $startresult['error']);
        $this->assertArrayHasKey('message', $startresult['error']);
        $this->assertEquals('userfield_not_selected', $startresult['error']['code']);
    }
    ...
    public function test_3(): void {
        ...
        $this->assertArrayHasKey('code', $startresult['error']);
        $this->assertArrayHasKey('message', $startresult['error']);
        $this->assertEquals('userfield_not_valid', $startresult['error']['code']);
    }
