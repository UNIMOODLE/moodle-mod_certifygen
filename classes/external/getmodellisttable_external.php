 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class getmodellisttable_external extends \core_external\external_api {
    /**
     * Describes the external function parameters.
     *
     * @return \core_external\external_function_parameters
     */
    public static function getmodellisttable_parameters(): \core_external\external_function_parameters {
     ...
     */
    public static function getmodellisttable_returns(): \core_external\external_single_structure {
        return new \core_external\external_single_structure(
            [
                'table' => new \core_external\external_value(PARAM_RAW, 'model list table'),
            ]
        );
    }
}
