 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class get_pdf_teacher_certificate_external extends \core_external\external_api {
    /**
     * Describes the external function parameters.
     *
     * @return \core_external\external_function_parameters
     */
    public static function get_pdf_teacher_certificate_parameters(): \core_external\external_function_parameters {
        return new \core_external\external_function_parameters(
            [
                ...
                'name' => new \core_external\external_value(PARAM_RAW, 'request name'),
                'courses' => new \core_external\external_value(PARAM_RAW, 'course list separated by commas.'),
                'modelid' => new \core_external\external_value(PARAM_INT, 'Model id'),
                'lang' => new \core_external\external_value(PARAM_RAW, 'certificate model type'),
            ]
        );
    }
     ...
     */
    public static function get_pdf_teacher_certificate_returns(): \core_external\external_single_structure {
